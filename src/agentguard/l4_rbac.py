"""
AgentGuard L4a — ABAC (Attribute-Based Access Control) policy evaluator.

Evaluates: role × verb × resource_sensitivity × upstream_risk_score
Returns:   ALLOW | DENY | ELEVATE

ELEVATE routes into existing approval_workflow.py HITL — zero new code needed.
Design: default-deny. Unknown role → DENY. No exceptions.

Research basis:
- OWASP Agentic AI Top 10: ASI-02 (Excessive Agency), ASI-03 (Identity Abuse)
- Zero-trust principle: never trust, always verify role + context
"""
