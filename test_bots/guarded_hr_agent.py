...
from hr_agent import HRAgent, TOOL_REGISTRY, TOOL_SCHEMAS
...
class _GuardedHRAgent(HRAgent):
    """HRAgent subclass that routes all tool calls through GuardedToolRegistry."""
